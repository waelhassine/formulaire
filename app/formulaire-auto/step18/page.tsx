...
export default function FormulaireStep10() {
  ...
  const { fields, append, remove } = useFieldArray({
    control,
    name: 'step18_card_conducteur_sinistres',
  });
  ...
  const validateStep = async () => {
    ...
    if (result && isValid) {
      router.push('/formulaire-auto/step19');
    }
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col space-y-4 lg:w-2/3">
        ...
        <p className="flex flex-row text-2xl pt-12">Le conducteur a til déclaré des sinistres ?</p>
